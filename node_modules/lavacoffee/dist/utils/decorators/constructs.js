...
exports.constructUnresolved = exports.constructTrack = exports.constructNode = exports.constructPlayer = exports.constructCoffee = exports.construct = exports.decorateConstructor = void 0;
const CoffeeLava_1 = require("../../structures/CoffeeLava");
...
function constructCoffee() {
    return decorateConstructor((coffee, args) => {
        ...
        if (typeof options.requiredPlugins !== "undefined" &&
...
exports.constructCoffee = constructCoffee;
function constructPlayer() {
    return decorateConstructor((player, args) => {
        const lava = args[0];
        const options = args[1];
        if (!(lava instanceof CoffeeLava_1.CoffeeLava))
            throw new TypeError("Lava must be instanceof CoffeeLava");
        if (!options)
