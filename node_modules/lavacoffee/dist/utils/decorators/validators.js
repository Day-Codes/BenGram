...
const CoffeeTrack_1 = require("../../structures/CoffeeTrack");
        ...
        return decorateMethod(function (func, trackOrTracks, offset) {
            ...
            if (Array.isArray(trackOrTracks) && trackOrTracks.length) {
                for (const track of trackOrTracks) {
                    if (!(CoffeeTrack_1.CoffeeTrack.isTrack(track) || CoffeeTrack_1.UnresolvedTrack.isUnresolved(track)))
                        throw error;
                }
            }
            else if (!(CoffeeTrack_1.CoffeeTrack.isTrack(trackOrTracks) || CoffeeTrack_1.UnresolvedTrack.isUnresolved(trackOrTracks))) {
                throw error;
            }
