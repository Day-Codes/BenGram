...
client.on("interactionCreate", async (interaction) => {
    ...
    if (!cmd) return interaction.reply({ content: "An error has occured!! Please Retry if not working join our support server! https://discord.gg/vyNaNKCsJT" });
